...
<?php require('head.php'); ?>
  ...
  <body>
    ...
    <!-- HEADER -->
    <?php $header['associativismo']='active'; require('header.php'); ?>

    <div class="top-shadow"></div>

    <div class="inner-page">
    <div class="slider-item" style="background-image: url('images/associativismo.jpg');">
        
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
              <h1 class="pt-5"><span>Associativismo</span></h1>
            </div>
          </div>
        </div>
    ...
    <section class="section border-t pb-0">
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/2.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/5.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/8.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/11.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/15.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/18.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/23.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/30.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/33.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/36.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/associativismo/37.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
