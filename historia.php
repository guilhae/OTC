    ...
    <section class="section blog element-animate">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <p>Neste momento, e encenada por Diana Lima e Marli Silva, a Oficina é constituída por elementos com idades compreendidas entre os 15 e os 75 anos – maioritariamente amadores.<br>
            Através do esforço e dedicação à arte, a Oficina conseguiu ressuscitar, e tenta manter viva, a tradição do Teatro no concelho.<br>
            Para tal, destaca-se a sua cooperação com a autarquia na organização do Festival de Teatro Deniz-Jacinto, uma das atividades de maior distinção e honra deste corpo associativo, de frequência anual. </p>
            ...
            <ul>
                ...
                <li> <b>«Lisístrata»</b>, de Aristófanes (2017);</li>
                <li> <b>«A Excepção e a Regra»</b>, de Bertolt Brecht (2016);</li>
                <li> <b>«Manipulação»</b>, criação coletiva (2014).</li>
            </ul>
