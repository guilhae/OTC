...
<?php require('head.php'); ?>
  ...
  <body>
    ...
    <!-- HEADER -->
    <?php $header['atividades']='active'; require('header.php'); ?>

    <div class="top-shadow"></div>

    <div class="inner-page">
    <div class="slider-item" style="background-image: url('images/atividades.jpg');">
        
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
              <h1 class="pt-5"><span>Atividades</span></h1>
            </div>
          </div>
        </div>
    ...
    <section class="section border-t pb-0">
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/atividades/IMG_6647.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/atividades/thumbnail_IMG_1379.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
          ...
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
              <img src="images/atividades/IMG_20200725_225404.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 element-animate">
            <a class="link-thumbnail">
