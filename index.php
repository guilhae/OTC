      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 order-md-2">
            <div class=""><div class="frame"><img src="/images/bem_vindo.jpg" alt="Image" class="img-fluid"></div></div>
          </div>

          <div class="col-md-5 pr-md-5">
            <div class="block-41">
              <h2 class="block-41-heading my-3">Olá, <br>bem vind@!</h2>
              <div class="block-41-text">
                <p>
                  Esta é a página oficial da Associação OTC - Oficina de Teatro de Condeixa.<br>
                  Aqui poderás conhecer em detalhe o nosso percurso, a nossa missão e a nossa família do Teatro.<br><br>
                  Aventura-te!
                </p>
              </div>
            </div>
